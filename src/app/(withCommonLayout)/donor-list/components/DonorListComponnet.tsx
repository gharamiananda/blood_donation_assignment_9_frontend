...
const DonorListCOmponent = () => {
  ...
  const { data: donorList,isLoading: isFetching,isError,error } = useGetAllDonorsQuery({ queryParams: { page: page, limit: 5, gender: selectedGender, bloogGroup: selectedBloodGroups, availability: availability === 'Yes' ? true : false, searchTerm: debounceText } }
  )
...
if (!isLoading && isError && error && !isFetching) {
  content = <h2>Something went wrong !</h2>
}
if (donorList?.data?.length ==0 && !isLoading  && !isFetching) {

    content =<h2 className='text-danger'>No Donors found</h2>  
                ...
                <div className="bl__sidebar__widget search__widget  bg-black  border border-danger ">
                  <form onSubmit={e => {
                    ...
                    <input
                      ...
                      }} type="text" placeholder="Search by donor name location" />
            ...
            <div className="col-xl-9">
              ...
              <section className="team  ">
                <div className="container">
                  ...
                  <motion.div className="row justify-content-start">
